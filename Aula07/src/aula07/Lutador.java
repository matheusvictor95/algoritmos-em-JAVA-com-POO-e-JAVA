...
public class Lutador {
    ...
    public Lutador(String no,String na, int id, float al, float pe, int vi, int de, int em) {
        ...
        public void apresentar(){
            System.out.println("----------------------------------------");
            System.out.println("CHEGOU A HORA! Vamos apresentar o competidor " + this.getNome());
        ...
        public void status(){
            ...
            System.out.println("Ganhou "+ this.getVitorias()+ " vezes e perdeu "+ this.getDerrotas()+" vezes e");
